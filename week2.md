...
Task2까지 했을 때 인공위성이 거의 보이지 않게 되었다
따라서 적합하지 않은 표라고 생각된다

### 더 나은 표현 방법

지구와 달 사이에 공백이 너무 많기에 이 공백에 정보들을 넣으면 좋다고 생각했다
따라서 Task2에서 지구와 달에 적용된 배율을 높이면 좋을 것이라고 생각한다

### 장점과 단점

| 장점 | 인공위성이 지구를 어떤 궤도로 돌고 있는지 확인 할 수 있다 |
| 단점 | 지구-인공위성-달의 거리와 크기 비율이 달라져 혼란을 겪을 수 있다 |
